...
def total_working_hours(employee_dict_dashboard):
    total_working_hour = employee_dict_dashboard.get('generate_dataframe', {}).get('EmployeeTotalWorkingHours', 'N/A')
...
def average_working_hours(employee_dict_dashboard):
    average_working_hour = employee_dict_dashboard.get('generate_dataframe', {}).get('EmployeeAverageWorkingHours', 'N/A')
...
def acutal_absantees(employee_dict_dashboard):
    actual_absantee = employee_dict_dashboard.get('generate_dataframe', {}).get('EmployeeActualAbsentee', 'N/A')
...
def late_marks_total(employee_dict_dashboard):
    late_mark = employee_dict_dashboard.get('generate_dataframe', {}).get('EmployeeLateMarksTotal', 'N/A')
...
def total_deduction(employee_dict_dashboard):
    total_leave_deduction = employee_dict_dashboard.get('generate_dataframe', {}).get('EmployeeAbsenteeWithLateMark', 'N/A')
